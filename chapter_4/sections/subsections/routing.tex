\subsection{Verbindungsmanagement/Routing und Peer Discovery}
...
Wie in Abschnitt \ref{subsec:identifikation_von_teilnehmern} (\nameref{subsec:identifikation_von_teilnehmern}) erwähnt, wird das Kademlia-Protokoll verwendet, um andere Teilnehmer (oder auch Peers) im Netzwerk zu finden und eine direkte Verbindung zu ihnen herzustellen.
